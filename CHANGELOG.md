...
- Agent-mode balance lookup now stays inside the TUI: the status line reports network activity and a dismissible transient popup shows the result without adding it to conversation or audit history.
